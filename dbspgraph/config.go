...
//go:generate mockgen -package mocks -destination mocks/mocks_serializer.go dbspgraph Serializer
//go:generate mockgen -package mocks -destination mocks/mocks_job.go github.com/virsel/work_scheduling/dbspgraph/job Runner
